...
- Compilar `vo` / `bed` como áudio misturado, `captions` como sidecar e
  `brand` como overlay no concat de imagem
- Nomear um join `fade` no score sem reescrever os slot_encode adjacentes
